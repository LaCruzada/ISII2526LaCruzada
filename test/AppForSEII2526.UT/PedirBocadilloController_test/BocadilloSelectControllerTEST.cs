    ...
    public class BocadilloSelectControllerTEST : AppForMovies.UT.AppForMovies4SqliteUT
    {
        ...
        public BocadilloSelectControllerTEST()
        {
            ...
            _context.Bocadillos.AddRange(
                new Bocadillo { Id = 1, Nombre = "Bocata Normal Barra", Tamano = EnumTamaño.Normal, Stock = 10, TipoPan = tipoPanBarra },
                new Bocadillo { Id = 2, Nombre = "Bocata Pequeño Bimbo", Tamano = EnumTamaño.Pequeño, Stock = 10, TipoPan = tipoPanBimbo },
                new Bocadillo { Id = 3, Nombre = "Bocata Normal Sin Stock", Tamano = EnumTamaño.Normal, Stock = 0, TipoPan = tipoPanBarra },
                new Bocadillo { Id = 4, Nombre = "Bocata Normal Bimbo", Tamano = EnumTamaño.Normal, Stock = 10, TipoPan = tipoPanBimbo }
            );
        ...
        public async Task GetBocadillosDisponibles_TodoBien_DevuelveResultadosCorrectos(string? tamano, int? tipoPanId, int expectedCount)
        {
