...
{
    /// <inheritdoc />
    public partial class MigracionBuena : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Producto",
                columns: new[] { "ProductoId", "Nombre", "PVP", "Stock", "TipoProductoId" },
                values: new object[,]
                {
                    { 1, "Camiseta Logo", 15.00m, 10, 1 },
                    { 2, "Camiseta Vintage", 18.50m, 3, 1 },
                    { 3, "Taza Café", 8.99m, 20, 2 },
                    { 4, "Gorro Invierno", 12.50m, 5, 3 }
                });
